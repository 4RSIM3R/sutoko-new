...
export const Treatment = ({ encounter }: TreatmentProps) => {

    return (
        <div className="w-full" >
            <div className="flex flex-row justify-between" >
                <div className="" >
                    <h1 className="text-xl font-semibold">Tindakan {encounter.patient?.name}</h1>
            ...
            <form className="py-2 grid grid-cols-12 gap-4">
                <div className="col-span-12 flex flex-col" >
                    <Label className="mb-1.5">Kode ICD 9</Label>
                    <AsyncSelect
